...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{UPLOADER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{UPLOADER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
uploader_server.pl - Catalyst Testserver

=head1 SYNOPSIS

uploader_server.pl [options]
